      ...
      contents: [
        {
          parts: [
            {
              text: `As a professional fashion stylist with advanced visual analysis capabilities, examine these two clothing items and provide a comprehensive outfit compatibility assessment.

ANALYSIS CRITERIA:
1. Visual Color Harmony - How well do the colors complement each other?
2. Style Cohesion - Do the style elements work together aesthetically?
3. Fabric Compatibility - Do the textures and materials create a balanced look?
4. Silhouette Balance - How do the shapes and proportions work together?
5. Overall Fashion Appeal - Professional styling perspective

INSTRUCTIONS:
- Analyze both images carefully using visual recognition
- Consider lighting, texture, and actual visual appearance
- Provide honest, professional fashion assessment
- Score from 0.0 to 1.0 (0.8+ for exceptional combinations)
- Keep reasoning concise but insightful (under 120 characters)

Format response as JSON: {"score": 0.85, "reason": "Excellent color harmony and complementary styles create a sophisticated look"}`
            },
            {
              inline_data: {
