    ...
    <Layout>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-2">
          <div>
            <h1 className="text-xl font-bold mb-1">Outfit Suggestions</h1>
            <div className="flex items-center gap-2 flex-wrap">
              <p className="text-sm text-muted-foreground">
                AI-powered combinations
              </p>
              {geminiStatus !== null && (
                <Badge variant={geminiStatus ? "default" : "outline"} className="text-xs font-normal px-1.5 py-0.5">
                  {geminiStatus ? "AI Enhanced" : "Basic"}
                </Badge>
              )}
            </div>
          </div>
          ...
          <div className="flex gap-1.5 flex-wrap justify-start sm:justify-end">
            <Button 
              ...
              className="hover-lift text-xs h-7"
              size="sm"
            >
              {processing ? (
                <>
                ...
                <>
                  ...
                  <span className="hidden sm:inline">Backgrounds Removed</span>
                  <span className="sm:hidden">Done</span>
                </>
              ) : (
                <>
                  <Image className="mr-1 h-3 w-3" />
                  <span className="hidden sm:inline">Remove Backgrounds</span>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="hover-lift text-xs h-7">
              ...
              <DropdownMenuContent>
                <DropdownMenuLabel className="text-xs">Match Quality</DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuCheckboxItem 
